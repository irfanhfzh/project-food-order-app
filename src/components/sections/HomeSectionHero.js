			...
			<Container>
				<Row className="align-items-center">
					<Col md={6}>
						...
						<div className="d-flex align-items-center intro-owner">
							<div>
							...
							<div>
								<Image src={HeroProfileImg} className="img-owner" />
							</div>
						</div>
					</Col>
					<Col md={1}></Col>
					<Col md={5}>
						<motion.div className="position-relative overflow-hidden">
							...
							<div className="position-absolute btn-wrapper-jelajahi-menu">
								<Nav.Link
